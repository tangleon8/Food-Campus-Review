...
<body>
    ...
    $message = ''; // Stores the messages

    //Writing a review asking for the restaurant, reviewer name, and review text
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if ($db->query($query) === TRUE) {
            $message = "New review added successfully"; //If everything validates from the POST, then it is submitted
        } else {
